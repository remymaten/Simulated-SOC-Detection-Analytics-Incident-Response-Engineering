...
The response moved the lab from detection to containment, validation, remediation, recovery, and preventive hardening.

![Incident Response Workflow](../evidence/07-incident-response.png)
